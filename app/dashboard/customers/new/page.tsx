    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        <Link href="/dashboard/customers" className="mb-3 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
          <ArrowLeft className="size-4" /> Customer overview
        </Link>
        <h1 className="text-2xl font-semibold">Onboard a customer</h1>
        <p className="text-muted-foreground">Create the workspace in four clear steps, then hand off one activation link.</p>
      </div>
